...
class  ArrayListProbsRunner{
	public static void main(String[] args){
		ArrayListProbs a = new ArrayListProbs();

		a.makeListAndPrint(10, 50); //make 10 random items, from 1 to 50
		...
		System.out.println(a.removeDupes(new ArrayList<String>(Arrays.asList("to", "to", "be", "be", "be", "or"))));
